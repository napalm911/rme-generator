...
public:
	...
	bool loadFromOtb(const wxFileName& datafile, wxString& error, wxArrayString& warnings);
	bool loadFromGameXml(const wxFileName& datafile, wxString& error, wxArrayString& warnings);
