...
public:
	...
	bool hasValidPaths();
	bool loadValidPaths();
	void setClientPath(const wxFileName& dir);
	...
	wxFileName getDataPath() const;
	wxFileName getLocalDataPath() const;
	wxFileName getClientPath() const { return client_path; }
