...
public:
	...
	virtual bool loadMap(Map& map, const wxFileName& identifier) = 0;
	virtual bool saveMap(Map& map, const wxFileName& identifier) = 0;
};
...
public:
	...
	virtual bool loadMap(Map& map, const wxFileName& identifier) { return false; }
	virtual bool saveMap(Map& map, const wxFileName& identifier) { return false; }
};
